...
function deleteMultiple(election_code) {
    ids_array = [];
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Array.from(ids_array).forEach(function (e) {
                    ...
                    var url = '/api/elections/'+election_code+'/voters/'+e;
                    console.log(url);
    ...
    } else Swal.fire('Which Voter?','Select at least one checkbox to delete the corresponding voter?','question');
}
