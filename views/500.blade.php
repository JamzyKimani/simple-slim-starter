...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>500 Error | {{ env('APP_NAME', 'Election System') }}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Online Voting Made Simple" name="description" />
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 text-center">
                            ...
                            <div>
                                ...
                                <a href="{{ url('login-page') }}" class="btn btn-success"><i class="mdi mdi-home me-1"></i>Back to home</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <!-- end row -->
